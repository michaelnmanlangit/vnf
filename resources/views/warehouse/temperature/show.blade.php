...
@section('title', 'Temperature Details')

@section('page-title', 'Temperature Details')
...
<div class="inventory-detail-container">
    <div class="detail-header">
        ...
        <a href="{{ route('warehouse.temperature.index') }}" class="btn-back">
            ...
            <div class="card-body">
                <div class="info-row">
                    <div class="info-item">
                        ...
                        <p style="font-weight: 700; color: #e74c3c; font-size: 1.2rem;">{{ $inventory->storage_temperature ?? 'Room Temperature' }}</p>
                    </div>
                    <div class="info-item">
                ...
                <div class="info-row">
                    <div class="info-item">
                        ...
                        <p>{{ $inventory->special_requirements ?? 'None specified' }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="detail-footer">
        <a href="{{ route('warehouse.temperature.index') }}" class="btn-back">
            ...
            Back to Temperature Monitoring
        </a>
    </div>
</div>
